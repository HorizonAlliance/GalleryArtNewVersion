          ...
          <div className="w-full flex flex-col lg:flex-row">
            <div className="flex justify-between items-center  flex-row w-full space-x-10">
              ...
              <div className="hidden lg:flex items-center space-x-4 ml-3">
                <a
                  href="/Login"
                  className="bg-indigo-50 text-[#48CFCB] rounded-full cursor-pointer font-semibold text-center shadow-xs transition-all duration-500 py-3 px-6 text-sm hover:bg-indigo-100"
                >
                  Login
                </a>
                <a
                  href="/Register"
                  className="bg-[#48CFCB] text-white rounded-full cursor-pointer font-semibold text-center shadow-xs transition-all duration-500 py-3 px-6 text-sm hover:bg-[#6439FF]"
                >
                  Sign up
                </a>
                <DarkModeToggle />
