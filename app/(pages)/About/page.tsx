  ...
  return (
    <>
      <section className="flex mx-auto w-full h-[100vh] px-8 bg-white dark:bg-black">
        <div className="relative sm:mx-5 lg:mx-10 sm:px-8 lg:px-15 w-full grid grid-cols-2">
          <motion.div
            variants={container}
            initial="hidden"
            animate="show"
            className="mx-auto w-full flex flex-col justify-center text-left sm:px-6 lg:px-10"
          >
            <motion.h1
              variants={item}
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-12">
            <motion.h2
              ...
              viewport={{ once: true }}
              className="font-manrope text-5xl text-center font-bold text-gray-900 "
            >
              Our Team{" "}
            </motion.h2>
          </div>
